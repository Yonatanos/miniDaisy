...
module.exports = {
  ...
  rules: {
    ...
    'no-async-promise-executor': 0, // TODO: Resolve on next regression session
    'no-await-in-loop': 0, // TODO: Resolve on next regression session,
    ...
    ], // Disallow unnecessary curly braces in JSX. Error example 1: <App>Hello world'}</App>; Error example 2: <App prop={'Hello world'} attr={'foo'} />;
